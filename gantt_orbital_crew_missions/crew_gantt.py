...
def generate(file_name="gantt_orbital_crew_missions/station_modules_gantt_chart",
    ...
    def parse_file():
        data = []
        current_team = None
        with open("gantt_orbital_crew_missions/missions_data.txt") as f:
            for line in f:
                line = line.strip()
    ...
    fig = px.timeline(df,
                    ...
                    y="Y_Label",
                    color="ColorGroup",
                    text=None, # text="Lead", # Toggle off names for this one
    ...
    fig.update_layout(
        ...
        paper_bgcolor="white",
        title = {
            "text": "<b>Crew Orbital Missions Timeline</b>",
...
generate("gantt_orbital_crew_missions/crew_orbital_missions_gantt_chart_4k",
         max_name_line_len=20,
         label_font_size=32,
         lead_name_font_size=20,
         title_font_size=48,
...
generate("gantt_orbital_crew_missions/crew_orbital_missions_gantt_chart_1080p",
         max_name_line_len=20,
         label_font_size=16,
